...
LaserPower_W = 0.25 # laser power in W
LaserRadius_inve2_um2 = 4 # 1/e^2 radius of laser beam, in um
...
for state in [Rb_state_1, Rb_state_2]:
    a = RbacStarkShift(state, LaserWavelength_nm=1064, LaserIntensity_kW_invcm2=LaserIntensity_kW_invcm2, print_polarizability=True, print_stark_shift=True)
    print(a.scattering_rate_invs)