...
#     SrFacStarkShift(state, LaserWavelength_nm=1064, LaserIntensity_kW_invcm2=LaserIntensity_kW_invcm2, print_dipole_moment=False, print_polarizability=True, print_stark_shift=True, print_scattering_rate=True)
