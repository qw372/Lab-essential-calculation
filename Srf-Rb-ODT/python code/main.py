...
for state in [SrF_state_1, SrF_state_2, SrF_state_3, SrF_state_4, SrF_state_5, SrF_state_6]:
    SrFacStarkShift(state, LaserWavelength_nm=1064, LaserIntensity_kW_invcm2=LaserIntensity_kW_invcm2, LaserPolarization=LaserPolarization, print_dipole_moment=False, print_polarizability=False, print_stark_shift=False, print_scattering_rate=True)
    # break
